    ...
    <Layout>
      ...
      <div className="flex container mx-auto">
        ...
        <section className="w-full md:w-3/5 text-center px-8 md:p-0">
          <h1 className="header my-12 text-[3em] tracking-[8px] pb-12">Location Two</h1>
          <MenuHeader ref={tappetizersRef}>Tappetizers</MenuHeader>
          <MenuItem
            dishName="Garlic fries"
            ingredients="Fresh Garlic, Olive Oil, Sea Salt"
            description="Includes Specialty Fries"
            price={8}
          />
          <MenuItem dishName="French Fries" ingredients="Spicy Mayo" description="Includes Specialty Fries" price={9} />
          <MenuItem
            dishName="Chilli Cheese fries"
            ingredients="Fries, Tri-tip Chili, Cheese Sauce, Green Onions, Sour Cream"
            description="Includes Specialty Fries"
            price={12}
          />
          ...
          <MenuItem
            dishName="MARGHERITA"
            ingredients="Classic Red Sauce, Fresh Tomatoes, Fresh Mozzarella Topped with Fresh Basil,  Drizzled with 100% Extra Virgin Olive Oil"
            price={13}
          />
          <MenuItem
            dishName="THE ITALIAN"
            ingredients="Classic Red Sauce, Red Peppers, Italian Sausage, Pepperoni, Roasted Mushrooms"
            price={15}
          />
          <MenuItem
            dishName="ISLAND BLAST"
            ingredients="Our Homemade White Sauce, Ham, Roasted Fresh Pineapple, Fresh Jalapeño, Topped with a BBQ Drizzle"
            price={14}
          />
          <MenuItem
