    ...
    <Layout>
      ...
      <section className="flex flex-col md:flex-row">
        <motion.div
          ...
          className="w-full md:w-1/3 md:p-16 p-8"
        >
        ...
        >
          <Image
            layout="fill"
            objectFit="cover"
            alt="Image of people pouring their own beer"
            src="/images/taps/taps-1.jpg"
          />
        </motion.div>
        <motion.div
          variants={slideRight}
      ...
      <section className="container mx-auto py-8 px-4 text-center">
        ...
        <div className="flex flex-col md:flex-row container justify-between items-center md:mt-8 md:mb-12 ">
          <div className="my-8 md:my-0">
            <Image width={252} height={164} alt="featured breweries company 1" src="/images/taps/taps-logo-1.png" />
          </div>
          <div className="my-8 md:my-0">
            <Image width={206} height={156} alt="featured breweries company 2" src="/images/taps/taps-logo-2.png" />
          </div>
          <div className="my-8 md:my-0">
            <Image width={360} height={111} alt="featured breweries company 3" src="/images/taps/taps-logo-3.png" />
          </div>
        </div>
      </section>
    </Layout>
